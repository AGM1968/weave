...
| `wv quality hotspots`       | Ranked hotspot report               |
...
28 tools for IDE integration (VS Code Copilot, Claude Code):
...
wv quality hotspots --top=5      # Show top hotspot files (complexity x churn)
wv quality diff                  # Compare current vs previous scan
...
- **Bash files** use regex heuristic metrics (nesting depth, function count, coupling)
