  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        topic: {
          type: "string",
          enum: ["workflow", "github", "learnings", "context"],
          description:
            "Topic to show: workflow (default, 5-step process), github (issue integration), learnings (format + commands), context (load policy + wv context usage)",
        },
      },
      required: [],
    },
