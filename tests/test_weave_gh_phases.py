...
from weave_gh.phases import _handle_existing_issue, sync_github_to_weave
...
class TestReopenGuard:
    ...
    def test_closed_issue_body_still_updated(self) -> None:
        ...
        with patch.multiple(
            "weave_gh.phases",
            get_edges_for_node=lambda _: [],
            render_issue_body=lambda *a, **k: "<!-- WEAVE:BEGIN hash=abc123 -->\nnew\n<!-- WEAVE:END -->",
