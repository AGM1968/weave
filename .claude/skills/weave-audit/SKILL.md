---
name: weave-audit
description: "Validate Weave graph integrity, find issues, and suggest fixes"
---
...
wv update wv-XXXX --status=todo  # If blockers are confirmed done
```
...
- [CRITICAL] wv-XXXX: Circular dependency detected
- [CRITICAL] wv-YYYY: Stuck active for 5 days
...
1. **Immediate:** Fix circular dependency in wv-XXXX
