---
name: sanity-check
description: "Validates assumptions before building on them to prevent error cascades from early wrong guesses. Use when requirements, environment, or prior conclusions are uncertain."
---
