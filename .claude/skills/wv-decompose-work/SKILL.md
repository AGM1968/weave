...
description: "Break down an epic into feature and task nodes with proper dependencies"
---
...
- **Priority**: [1-5]
- **Tasks**:
  - wv-ZZZZ: [Task description] (Priority: 1)
  - wv-AAAA: [Task description] (Priority: 2)
  - ...
...
Epic (wv-XXXX) ├── Feature 1 (wv-YYYY) │ ├── Task 1.1 (wv-ZZZZ) │ ├── Task 1.2 (wv-AAAA) │ └── Task
1.3 (wv-BBBB) ├── Feature 2 (wv-CCCC) │ ├── Task 2.1 (wv-DDDD) │ └── Task 2.2 (wv-EEEE) └── Feature
3 (wv-FFFF) └── Task 3.1 (wv-GGGG)

## Work Queue

Ready to start (in priority order):

1. wv-ZZZZ: Task 1.1 [High value, no blockers]
2. wv-AAAA: Task 1.2 [Can be done in parallel]
...
3. Claim and start work: `wv update wv-XXXX --status=active`
