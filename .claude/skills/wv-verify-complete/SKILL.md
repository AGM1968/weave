...
description: "Requires verification evidence before closing work to prevent 'looks right' from replacing 'works right'. Use when validating completion prior to wv done or ship."
---
